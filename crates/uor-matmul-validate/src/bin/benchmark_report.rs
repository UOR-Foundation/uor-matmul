...
fn main() -> Result<(), String> {
    ...
    html.push_str(
        ...
        *{box-sizing:border-box}body{margin:0;background:var(--wash);color:var(--ink);font:15px/1.55 -apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}main{max-width:1120px;margin:0 auto;padding:0 1.25rem 3rem}
        ...
        @page{size:A4 landscape;margin:10mm}@media print{body{background:#fff;font-size:11px;line-height:1.4}main{max-width:none;padding:0}header{padding:0 0 .8rem}h1{font-size:1.65rem}h2{font-size:1.2rem;margin:1.2rem 0 .5rem}h3{font-size:1.05rem}h2,h3,.chart-title{break-after:avoid-page}nav{display:none}.highlight{break-inside:avoid-page}.comparison{padding:.7rem .8rem;margin:.7rem 0;border-left-width:2px}.comparison p{margin:.15rem 0 .45rem}.chart-wrap,.scaling-chart-wrap{overflow:visible;break-inside:avoid-page;margin-top:.65rem;padding-top:.5rem}.chart,.scaling-chart{min-width:0}.chart-title{font-size:.75rem}.chart-note,.legend{font-size:.7rem}table{margin:.55rem 0;font-size:9px}thead{display:table-header-group}tr{break-inside:avoid-page}th,td{padding:.28rem .4rem}a{color:inherit;text-decoration:none}}
