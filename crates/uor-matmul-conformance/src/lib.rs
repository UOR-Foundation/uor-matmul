//! The BDD runner and the honesty meta-gate (R4, R9, `CM-02`, `CM-03`).
//!
//! Two jobs, and they are different in kind.
//!
//! **R9, feature-first.** Every capability begins as a Gherkin scenario. The
...
//! behind it.
//!
//! **R4, the meta-gate.** The honesty levels only mean something if the suite
